...
%----------------EXPERIENCE--------------------
	\section{Work Experience \hfill  {\small \href{https://www.linkedin.com/in/ppnoushad/}{\includegraphics[scale=0.075]{LI-Logo}}}}\label{sec:work-experience}
		\worksubsection{FlixMobility Tech GmBH}{Berlin, Germany}{Senior Software Engineer}{Jan 2019--present}{
			\item[\textbf{--}] Collaborate with stake-holders and product owner to determine the requirement feasibility.
