...
%----------------EXPERIENCE--------------------
	\section{Work Experience \hfill  {\small \href{https://www.linkedin.com/in/ppnoushad/}{\includegraphics[scale=0.075]{LI-Logo}}}}
		...
		\vspace{-12pt} % because its the same company removed header and moved closer to previous section
		\\
...
%--------------------SKILLS--------------------------
	\section{Skills}
		\item[]
		\begin{itemize}
			\resitem{Typescript/Javascript, Nodejs(NestJs/ExpressJs), React, Redux/SWR, recharts, CSS/SASS, webpack, yarn, npm}
			\resitem{Docker, Kubernetes, AWS(dynamodb, s3, eks/ec2), gitlab-ci, terraform, Azure-AD, Agile Methodologies, \LaTeX}
		\end{itemize}
