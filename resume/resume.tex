...
%----------------EXPERIENCE--------------------
	\section{Work Experience \hfill  {\small \href{https://www.linkedin.com/in/ppnoushad/}{\includegraphics[scale=0.075]{LI-Logo}}}}\label{sec:work-experience}
		\worksubsection{FlixMobility Tech GmBH}{Berlin, Germany}{
			\item[]\worksubsectionjobtitle{Staff Software Engineer}{Nov 2023--present}
			...
			\item[]\worksubsectionjobtitle{Senior Software Engineer}{Jan 2019--Oct 2023}
		...
		\vspace{10pt}
		\\
		\worksubsection{Pole Tech Labs Pvt Ltd}{Ahmedabad, India}{
			\item[]\worksubsectionjobtitle{Frontend Architect}{Apr 2017--Sep 2018}
			...
			\item[]\worksubsectionjobtitle{Founding Full-stack Engineer}{Jul 2016--Mar 2017}
			...
			\item[\textbf{--}] Technologies: \textit{Javascript, NodeJs, Express, React, Postgres, Redis, MongoDb, AWS, React, Angular, Firebase, Cloudinary}
		}
		\vspace{10pt}
		\\
		\worksubsection{Bullfinch Softwares}{Bangalore, India}{
			\item[]\worksubsectionjobtitle{Software Engineer}{Jul 2015--Jun 2016}
			...
			\item[\textbf{--}] Technologies: \textit{Javascript, React, RubyOnRails, AngularJs, HTML5/CSS3, WinJS, Heroku}
		}
		\vspace{10pt}
		\\
		\worksubsection{Toobayna Holidays}{Sulthan Bathery, India}{
			\item[]\worksubsectionjobtitle{Co-founder}{Aug 2013--Jun 2015}
